<template>
    ...
    <div>
        <div class="options">
            ...
            <div class="input-len" style="width: 490px">
            ...
            <div class="input-len">
                ...
                <div class="input">
                    <a-select id="status" default-value="" style="width: 170px" @change="SelectChange"
        ...
        <span slot="startTime" slot-scope="startTime">
            ...
            <div class="action-btn" slot="action" slot-scope="text,action,i">
                <a @click="details(text,action,i)">订单详情</a>
            </div>
        </a-table>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            startTimeChange(date, dateString) {
                ...
                this.startModel = this.$moment(dateString, 'yyyy-MM-dd HH:mm:ss');
                this.options.startTime = dateString;
            },
            endTimeChange(date, dateString) {
                console.log(date, dateString)
                this.endModel = this.$moment(dateString, 'yyyy-MM-dd HH:mm:ss');
            ...
            details(text, action, index) {
                console.log(text, action, index)
                //'/orderDetails'
                console.log(action)
                this.$router.push({name: 'OrderDetails', params: {id: action.id}})
            },
            SelectChange(value) {
                console.log(value)
